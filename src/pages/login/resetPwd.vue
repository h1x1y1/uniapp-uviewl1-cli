	...
	<view class="container">
		...
		<view class="li-login-form">
			...
			<view class="li-form-btns">
				<button class="cu-btn login-btn color-white flex flex-center u-col-center" @tap="submit">修改密码</button>
			</view>
		</view>
		<!-- 验证码组件 -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 找回
			goRegist(email, code, password, repeat_password) {
				let that = this
				let params = {
					email,
					code,
				...
				resetPasswordByEmail(params).then(({
					data: {
						code,
						data,
						msg
