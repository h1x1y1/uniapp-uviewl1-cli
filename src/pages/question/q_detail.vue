	...
	<view>
		...
		<view>
			<u-cell-group title="来源明细">
				<u-cell-item size="large" style='padding: 1px 17px;' :value="q_list.assets" isLink :border-bottom="false" @tap="findEqu">
					<view slot="title">设备资产 <span class="color_red">*</span></view>
				</u-cell-item>
				...
				<u-cell-item size="large" style='padding: 1px 17px;' title="对应仪表" :arrow="false" :border-bottom="false">
					<u-input slot="right-icon" placeholder="请输入" :clearable="true" input-align="right" v-model="q_list.inputName"></u-input>
				</u-cell-item>
				<u-cell-item size="large" style='padding: 1px 17px;' title="对应仪表读数" :arrow="false" :border-bottom="false">
					<u-input slot="right-icon" placeholder="请输入" :clearable="true" input-align="right" v-model="q_list.inputNum"></u-input>
				</u-cell-item>
			...
			<view class="reason_bg">
				...
				<view class="text_area">
					<textarea 
					 ...
					 placeholder-style="font-size: 24rpx;font-weight: 400;color: #D9D9D9;padding: 10rpx;"
					 :maxlength="maxlength"
					 placeholder="概述需要的服务内容"
					 rows="4"
					 cols="30"
					 v-model="q_list.Overview">
					</textarea>
				</view>
			</view>
			...
			<u-row gutter="16" justify="center" style="padding: 20rpx 0;">
				...
				<u-col span="5.5">
					<view class="demo-layout bg-purple-light">
						<u-button ripple type="error" class="btn_l" @click="toChange">
